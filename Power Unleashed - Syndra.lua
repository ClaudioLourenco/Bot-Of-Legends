...
local SCRIPT_NAME = "Power Unleashed - Syndra"
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
if AUTOUPDATE then
SourceUpdater(SCRIPT_NAME, version, "raw.github.com", "/iAMShawn/Bot-Of-Legends/blob/master/"..SCRIPT_NAME..".lua", SCRIPT_PATH .. GetCurrentEnv().FILE_NAME, "/iAMShawn/Bot-Of-Legends/blob/master/"..SCRIPT_NAME..".version"):CheckUpdate()
end
...
local Delays = {[_Q] = 0.5, [_W] = 0.5, [_E] = 0.5, [_R] = 0.25, [_QE] = 2000} ---_QE delay updates in function of _E delay + Speed and the distance to the ball
local Speeds = {[_Q] = math.huge, [_W] = 1400, [_E] = 2500, [_R] = 1100, [_QE] = 1600}
...
Menu = scriptConfig("Power Unleashed", "Syndra")
...
Menu.Harass:addParam("Enabled2", "Harass (toggle)!", SCRIPT_PARAM_ONKEYTOGGLE, false, string.byte("A"))
...
Menu.R:addParam("CastR", "Force ultimate cast", SCRIPT_PARAM_ONKEYDOWN, false, string.byte("R"))
...
Menu.Misc:addParam("Whitchance", "W min hitchance(3 - insta cast)", SCRIPT_PARAM_SLICE, 2, 1, 2)
